...
api_target_types: dict[str, str | tuple[str, str]] = {
    ...
    "qrules.quantum_numbers.baryon_number": "class",
    "qrules.quantum_numbers.bottomness": "class",
    "qrules.quantum_numbers.c_parity": "class",
    "qrules.quantum_numbers.charge": "class",
    "qrules.quantum_numbers.charmness": "class",
    "qrules.quantum_numbers.electron_lepton_number": "class",
    "qrules.quantum_numbers.g_parity": "class",
    "qrules.quantum_numbers.isospin_magnitude": "class",
    "qrules.quantum_numbers.isospin_projection": "class",
    "qrules.quantum_numbers.mass": "class",
    "qrules.quantum_numbers.muon_lepton_number": "class",
    "qrules.quantum_numbers.parity": "class",
    "qrules.quantum_numbers.pid": "class",
    "qrules.quantum_numbers.spin_magnitude": "class",
    "qrules.quantum_numbers.spin_projection": "class",
    "qrules.quantum_numbers.strangeness": "class",
    "qrules.quantum_numbers.tau_lepton_number": "class",
    "qrules.quantum_numbers.topness": "class",
    "qrules.quantum_numbers.width": "class",
    "qrules.quantum_numbers.l_magnitude": "class",
    "qrules.quantum_numbers.l_projection": "class",
    "qrules.quantum_numbers.parity_prefactor": "class",
    "qrules.quantum_numbers.s_magnitude": "class",
    "qrules.quantum_numbers.s_projection": "class",
    "qrules.solving.GraphElementProperties": "class",
    "qrules.solving.GraphSettings": "class",
    "qrules.transition.StateTransition": "class",
}
