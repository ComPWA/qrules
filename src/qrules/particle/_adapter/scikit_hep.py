"""Convert records from the scikit-hep particle database to QRules particles."""
...
# The neutral kaon mass eigenstates do not have a definite flavor, while the B(s2)
# entries have inconsistent isospin information for QRules' particle model.
__skip_particles = {
