...
[![Open in Visual Studio Code](https://img.shields.io/badge/vscode-open-blue?logo=visualstudiocode)](https://github.dev/ComPWA/qrules)
...
```shell
git clone https://github.com/ComPWA/qrules
cd qrules
```
